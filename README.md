...
[![Official Website](https://img.shields.io/badge/Official_Website-litewave.miosmooth.com-0284c7?style=for-the-badge&logo=googlechrome&logoColor=white)](https://litewave.miosmooth.com)
...
> 🌐 **Official Website & Downloads:** [https://litewave.miosmooth.com](https://litewave.miosmooth.com)
...
## อัปเดตอัตโนมัติบน Windows

สำหรับ Windows รุ่นติดตั้ง (`LiteWave-Setup-Windows-x64.exe`) LiteWave สามารถตรวจสอบเวอร์ชันใหม่จาก GitHub Releases และอัปเดตแบบ in-place ได้โดยตรงจากเมนู **Check for Updates** เมื่อมีรุ่นใหม่ โปรแกรมจะดาวน์โหลดตัวติดตั้งล่าสุด ปิด LiteWave ติดตั้งทับแบบ silent และเปิดโปรแกรมกลับมาโดยอัตโนมัติ โดยไม่ลบข้อมูลผู้ใช้เดิม

> รุ่น Portable (`.zip`) ไม่ได้ติดตั้งลงระบบ จึงควรดาวน์โหลด Portable รุ่นล่าสุดแล้วแทนที่โฟลเดอร์เดิมด้วยตนเอง
